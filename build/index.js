...
var ioc_lib_js_1 = require("ioc-lib.js");
...
var context = new ioc_lib_js_1.MetadataContext(configs);
...
var serviceFromContext = context.getComponentEntityInstance('service');
